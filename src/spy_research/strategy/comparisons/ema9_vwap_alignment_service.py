"""Read-only Stage 10.4 composition over frozen Stage 3 and Stage 9 data."""
...
class Ema9VwapAlignmentComparisonService:
    """Attach exact confirmation-row EMA9/VWAP labels to frozen outcomes."""
    ...
    def calculate(self, *, start: date, end: date) -> Ema9VwapAlignmentComparisonResult:
        ...
        annotations = annotate_confirmed_ema9_vwap_alignment(
        ...
        return calculate_ema9_vwap_alignment_comparison(
            setup_result,
            outcome_result,
            base_statistics,
            annotations,
